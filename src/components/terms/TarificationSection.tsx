...
export const TarificationSection = () => {
  return <div className="space-y-4 mb-6">
      ...
      <p className="text-justify">Les mercredis doivent être réservés au plus tard deux semaines à l'avance (jusqu'au mardi soir).</p>
      <p className="text-justify">La réservation se fait <strong>à la journée complète</strong>, avec ou sans repas (pas de demi-journée possible).</p>
      <p className="text-justify">Le nombre de mercredis réservés dépend des besoins de chaque famille.</p>
      <p className="text-justify">L'inscription est <strong>validée uniquement après le règlement de la facture.</strong></p>
      <p className="text-justify">En cas d'absence de votre enfant, merci de prévenir <strong>au moins huit jours à l'avance (avant le mardi 18h)</strong> auprès de l'accueil de l'Espace des 2 rives. Cela permet d'annuler le repas, d'éviter le gaspillage alimentaire et d'organiser au mieux l'équipe d'encadrement. Passé ce délai, la journée restera facturée.</p>
      <p className="text-justify">La directrice se réserve le droit de refuser l'accueil de votre enfant si les absences sont répétées et non signalées dans les délais. Le tarif est calculé en fonction du quotient familial. Le goûter est fourni par l'association sans coût supplémentaire.</p>
