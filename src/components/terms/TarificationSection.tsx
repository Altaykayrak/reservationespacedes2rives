...
La réservation se fait à la journée complète, avec ou sans repas (pas de demi-journée possible). Le nombre de mercredis réservés dépend des besoins de chaque famille. L'inscription est validée uniquement après le règlement de la facture. En cas d'absence de votre enfant, merci de prévenir au moins huit jours à l'avance (avant le mardi 18h) auprès de l'accueil de l'Espace des 2 rives. Cela permet d'annuler le repas, d'éviter le gaspillage alimentaire et d'organiser au mieux l'équipe d'encadrement. Passé ce délai, la journée restera facturée. 
