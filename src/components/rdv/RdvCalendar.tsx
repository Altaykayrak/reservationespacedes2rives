...
export const RdvCalendar = ({
  ...
  return <Card className="h-full">
      ...
      <CardContent className="pt-0">
        <Calendar mode="single" selected={selectedDate} onSelect={setSelectedDate} locale={fr} className="mx-auto scale-95 transform origin-top-left pointer-events-auto" defaultMonth={defaultMonth} disabled={date => {
