  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://dddtybmradplydzymrly.supabase.co/storage/v1/object/public/images/Facadee2r.jpg')`,
