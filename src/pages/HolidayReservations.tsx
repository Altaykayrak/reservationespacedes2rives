  ...
  return <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      ...
      <div className="container mx-auto p-4 md:p-6 space-y-6 max-w-7xl">
        <div className="space-y-2">
          ...
          <p className={`text-red-600 font-bold text-sm md:text-base ${isBlinking ? 'animate-blink' : ''}`}>Sélectionner au moins 1 jour par semaine. En cas de journée complète, merci de contacter l'accueil pour une inscription sur liste d'attente.</p>
        </div>
