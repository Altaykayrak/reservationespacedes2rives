      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="mb-12 border p-6 rounded-lg bg-gray-50">
          ...
          <div className="space-y-4 mb-6">
            ...
            <p>La facture périscolaire est à régler dans un délai de 8 jours à réception de celle-ci par mail. Toute facture non acquittée suspendra l'accueil de votre enfant sans délai de prévenance.</p>
            ...
            <p>Les mercredis sont à réserver huit jours avant (au plus tard le mardi pour le mercredi de la semaine suivante). La réservation se fait à la journée (pas de réservation en demi-journée) avec ou sans repas. Le nombre de mercredis réservés est en fonction des besoins de la famille. L'inscription est validée uniquement après paiement de la facture.</p>
            
            <p>Le tarif est calculé en fonction du quotient familial.</p>
            
            <p>Le goûter est fourni par l'association sans coût supplémentaire.</p>
            
            <p>Il vous est demandé de prévenir avant le lundi 11h l'accueil de l'Espace des 2 rives si votre enfant est absent afin d'annuler le repas, d'éviter le gaspillage alimentaire et pour organiser l'équipe d'encadrement. Un avoir sera établi uniquement sur présentation d'un certificat médical.</p>
            
            <p className="font-semibold mt-6">Concernant les vacances scolaires :</p>
            <p>La réservation se fait sur trois jours minimum (exception faite d'un jour férié dans la semaine). Le règlement est à effectuer au moment de l'inscription. Il est possible de réserver jusqu'au mercredi pour la semaine suivante en fonction des places disponibles.</p>
            <p>Le tarif est calculé en fonction du quotient familial.</p>
            <p>Le goûter est fourni par l'association sans coût supplémentaire.</p>
            
            <p>Le remboursement n'est applicable que sur présentation d'un certificat médical pour une maladie supérieure à 3 jours (le délai de carence correspond au premier jour d'absence et aux 2 jours calendaires qui suivent).</p>
        ...
        <h1 className="text-3xl font-bold mb-8">CONDITIONS GÉNÉRALES D'UTILISATION ET RÈGLES DE FONCTIONNEMENT</h1>
