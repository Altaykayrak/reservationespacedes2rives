            ...
            <CardContent className="p-6">
              <div className="mb-4">
                <Carousel className="w-full">
                  <CarouselContent>
                    {maternelleImages.map((image, index) => <CarouselItem key={index}>
                        <div className="relative group">
                          <AspectRatio ratio={16 / 9} className="overflow-hidden rounded-lg">
                            <img src={image.src} alt={image.alt} className="w-full h-full object-cover cursor-pointer transition-transform duration-200 group-hover:scale-105" onClick={() => handleImageClick(image)} />
                          </AspectRatio>
          ...
          <Card className="overflow-hidden">
            ...
            <CardContent className="p-6">
              <div className="mb-4">
                <Carousel className="w-full">
                  <CarouselContent>
                    {elementaryImages.map((image, index) => <CarouselItem key={index}>
                        <div className="relative group">
                          <AspectRatio ratio={16 / 9} className="overflow-hidden rounded-lg">
                            <img src={image.src} alt={image.alt} className="w-full h-full object-cover cursor-pointer transition-transform duration-200 group-hover:scale-105" onClick={() => handleImageClick(image)} />
                          </AspectRatio>
          ...
          <Card className="overflow-hidden">
            ...
            <CardContent className="p-6">
              <div className="mb-4">
                <Carousel className="w-full">
                  <CarouselContent>
                    {teenImages.map((image, index) => <CarouselItem key={index}>
                        <div className="relative group">
                          <AspectRatio ratio={16 / 9} className="overflow-hidden rounded-lg">
                            <img src={image.src} alt={image.alt} className="w-full h-full object-cover cursor-pointer transition-transform duration-200 group-hover:scale-105" onClick={() => handleImageClick(image)} />
                          </AspectRatio>
